...
public class ExternalSort {
	...
	public static void main(final String[] args) throws IOException {
		...
		final Comparator<String> comparator = defaultcomparator;
		final List<File> l = sortInBatch(new File(inputfile), comparator,
	 ...
	 */
	public static int mergeSortedFiles(final List<File> files, final File outputfile,
			final Comparator<String> cmp, final Charset cs) throws IOException {
	...
	public static int mergeSortedFiles(final List<File> files, final File outputfile,
			final Comparator<String> cmp, final Charset cs, final boolean distinct,
			final boolean append, final boolean usegzip) throws IOException {
	...
	public static File sortAndSave(final List<String> tmplist,
			final Comparator<String> cmp, final Charset cs, final File tmpdirectory)
					throws IOException {
	...
	public static File sortAndSave(final List<String> tmplist,
		...
		final File newtmpfile = File.createTempFile("sortInBatch",
	 ...
	 * @throws IOException
	 */
	public static List<File> sortInBatch(final File file, final Comparator<String> cmp)
			throws IOException {
	 ...
	 */
	public static List<File> sortInBatch(final File file, final Comparator<String> cmp,
			final int maxtmpfiles, final Charset cs, final File tmpdirectory, final boolean distinct)
					throws IOException {
